...
export class CompanyDashboardComponent implements OnInit {
  ...
  getRevenueYAxisLabel(): string {
    const revenue = this.translationService.translateInstant('companyDashboard.revenue');
    const currency = this.translationService.translateInstant('companyDashboard.currency');
